...
import com.cjack.meetingroomadmin.service.AboutUsService;
...
public class AboutUsEndpoint extends BaseEndpoint{
    ...
    public AjaxResult list() {
        try{
            List<AboutUsModel> datas = service.list();
    ...
    @ResponseBody
    public AjaxResult addOrUpdate( AboutUsModel model) {
        try{
