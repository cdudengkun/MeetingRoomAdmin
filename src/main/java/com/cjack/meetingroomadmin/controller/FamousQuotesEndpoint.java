...
import com.cjack.meetingroomadmin.service.FamousQuotesService;
...
@Controller
@RequestMapping("/famousQuotes")
public class FamousQuotesEndpoint extends BaseEndpoint{

    @Autowired
    FamousQuotesService service;
    ...
    @ResponseBody
    public AjaxResult addOrUpdate( FamousQuotesModel model) {
        try{
