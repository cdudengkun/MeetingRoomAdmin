...
import com.cjack.meetingroomadmin.service.FamousTeacherService;
...
public class FamousTeacherEndpoint extends BaseEndpoint{

    @Autowired
    FamousTeacherService service;
    ...
    @ResponseBody
    public AjaxResult addOrUpdate( FamousTeacherModel model) {
        try{
