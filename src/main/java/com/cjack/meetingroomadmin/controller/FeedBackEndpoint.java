...
import com.cjack.meetingroomadmin.service.FeedBackService;
...
public class FeedBackEndpoint extends BaseEndpoint{
    ...
    @ResponseBody
    public AjaxResult list( LayPage layPage, FeedBackModel model) {
        try{
    ...
    @ResponseBody
    public AjaxResult addOrUpdate( FeedBackModel model) {
        try{
