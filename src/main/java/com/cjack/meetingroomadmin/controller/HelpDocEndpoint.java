...
import com.cjack.meetingroomadmin.service.HelpDocService;
...
public class HelpDocEndpoint extends BaseEndpoint{

    @Autowired
    HelpDocService service;
    ...
    public AjaxResult list() {
        try{
            List<HelpDocModel> datas = service.list();
    ...
    @ResponseBody
    public AjaxResult addOrUpdate( HelpDocModel model) {
        try{
