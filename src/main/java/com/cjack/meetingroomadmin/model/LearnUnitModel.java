...
public class LearnUnitModel {

    private Long id;
    private Date createTime;
    private Date updateTime;
    private Integer currentLearnUnit;//1-是，2-否
    private BookUnitModel unit;//关联单元
    private AppUserModel appUser;// 所属用户
    private LearnBookModel learnBook;//对应的学习课本
    ...
    //单元对应的复习记录
    private List<LearnUnitReviewDetailModel> learnUnitReviewDetails;
    //单元对应的测试记录
    private List<TestUnitModel> testUnits;
}
