layui.use(['form', 'table', 'util', 'baseConfig'], function () {
    ...
    var tableIns = table.render({
        ...
        cols: [[
            ...
            {field: 'name', width: 200, title: '联系人'},
            {field: 'phone', width: 200, title: '联系电话'},
            {field: 'detail', width: 400, title: '公司地址', templet : function( d){
                return d.provinceName + d.cityName + d.countyName + d.detail;
            }},
            {field: 'createTime', width: 200, title: '申请时间', templet : function( d){
