layui.use(['form', 'table', 'util', 'baseConfig'], function () {
    ...
    var tableIns = table.render({
        ...
        defaultToolbar: [],
        cols: [[
            {field: 'name', width: 200, title: '联系人姓名'},
            {field: 'phone', width: 200, title: '联系人电话'},
            {field: 'content', width: 400, title: '反馈内容'},
            {field: 'createTime', width: 200, title: '反馈时间', templet : function( d){
