layui.use(['form','layer', 'baseConfig', "upload"], function () {
    ...
    //------------加载搜索表单下拉框
    var meetingZoneId = data ? data.meetingZoneId: null;
    var levelId = data ? data.levelId: null;
    baseConfig.loadSelect( "/meetingZone/listAll", "meetingZoneId", meetingZoneId, "name");
    baseConfig.loadSelect( "/singleKey/list/1", "levelId", levelId, "dataKey");
    /**
