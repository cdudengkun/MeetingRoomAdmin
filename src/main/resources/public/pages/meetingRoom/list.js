layui.use(['form', 'table', 'util', 'baseConfig'], function () {
    ...
    //------------公共配置
    var pageName = "meetingRoom";
    var minWidth = 900;
    var minHeight = 800;
    var formTitleSuffix = "会议室";
    ...
    var tableIns = table.render({
        ...
        defaultToolbar: [],
        cols: [[
            {field: 'addrDetail', width: 300, title: '会议室楼层位置'},
            {field: 'levelName', width: 150, title: '规格'},
            {field: 'capicity', width: 150, title: '容量'},
            {field: 'name', width: 300, title: '所属会议中心', templet : function( d){
                return d.meetingZoneModel.name;
            }},
            {field: 'price', width: 150, title: '价格(元/小时)'},
    ...
    //------------加载搜索表单下拉框
    baseConfig.loadSelect( "/meetingZone/listAll", "meetingZoneId", null, "name");
    baseConfig.loadSelect( "/singleKey/list/1", "levelId", null, "dataKey");
