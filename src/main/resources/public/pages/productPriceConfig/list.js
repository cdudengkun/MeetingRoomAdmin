layui.use(['form', 'table', 'util', 'baseConfig'], function () {
    ...
    var tableIns = table.render({
        ...
        defaultToolbar: [],
        cols: [[
            {field: 'name', width: 200, title: '会员服务名称'},
            {field: 'type', width: 200, title: '服务类型', templet : function( d){
                switch (d.type) {
                    case 1: return "会员续订服务";
                }
            }},
            {field: 'price', width: 200, title: '原价'},
            {field: 'disCountPrice', width: 200, title: '优惠价格'},
            {field: 'disCountIntroduction', width: 200, title: '优惠活动说明'},
            {field: 'simpleIntroduction', width: 200, title: '简略服务介绍'},
            {field: 'followPriceIntroduction', width: 200, title: '继续续费说明'},
